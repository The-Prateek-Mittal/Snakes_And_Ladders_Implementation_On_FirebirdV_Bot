...
// Definitions for ATmega2560 micro-controller on Firebird V robot
	...
	#define bar_graph_led_1_pin			0
	#define bar_graph_led_2_pin			1			// PB1	( IO9 )
	#define bar_graph_led_3_pin			2
	#define bar_graph_led_4_pin			3
	#define bar_graph_led_5_pin			4
	#define bar_graph_led_7_pin			6
	#define bar_graph_led_8_pin			7			// PB0	( IO8 )
